    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('edu', 'Education'), ('exp', 'Experience'), ('skl', 'Skill'), ('oth', 'Others')], help_text='The type of the section. Can be Education, Experience, Skill, Strength, Project or Others.', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.ManyToManyField(blank=True, related_name='alias_skills', to='RESUME.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Proficiency',
