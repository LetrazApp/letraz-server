    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_process', models.ForeignKey(blank=True, help_text='Current thumbnail generation process', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='thumbnail_resumes', to='CORE.process')),
